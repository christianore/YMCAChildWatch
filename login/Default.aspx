<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ChildWatch.Default" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="childList">
        ...
        <button type="button" onclick="signinFamily()">Sign In</button>
    </div>
    ...
    <script>
        ...
        function validate() {
            ...
            $.ajax({
                url: "http://localhost:56354/Default.aspx/ValidateMember",
                data: json,
                type: "POST",
                dataType: "json",
        ...
        function signinFamily() {
            ...
            $.ajax({
                url: "http://localhost:56354/Default.aspx/SigninMembers",
